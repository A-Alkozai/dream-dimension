...
def draw(canvas):
    ...
    # for entity in gameManager.all_entities:
    #         entity.update()

    #         interaction.calculate_all_collisions(gameManager.all_entities)
    ...
    #         interaction.calculate_all_collisions(object.all_entities)
